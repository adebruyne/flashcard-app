...
    ('Concepts', 'Describe a Promise', $$It's like a normal promise. A person says they are going to do something in the future -- an operation that hasn not completed yet, but is expected in the future.', 'http://exploringjs.com/es6/images/promises----promise_states_all.jpg'),
