--seeding the flashards database - 3 decks, 10 cards each
...
VALUES
    ('Concepts', 'Back-End Processing', $$It’s like the ground beneath a city. Above ground are all the familiar sights – HTML houses, CSS cathedrals, Javascript office blocks. Beneath the ground are the utilities that make the city function smoothly – a labyrinthine network of web servers, applications, and databases.$$, 'https://content-static.upwork.com/blog/uploads/sites/3/2015/05/05110024/Back-end-dev-logo.png'),
    ('Concepts', 'Front-End Processing', $$It’s like walking around a city. You interact with the front end
– the sidewalks, roads, shops, parks, and office blocks. What you don’t see is the back end that keeps the city ticking – the power lines, gas pipes,sewers, and building foundations hidden underground.$$, 'https://www.classicinformatics.co.uk/wp-content/uploads/2013/04/ui-web-design-prosess1.jpg'),
...
    ('Concepts', 'Describe Cloud Computing', $$It’s like a library, not a book store. A simple way to access every book on the planet without having to own them all.$$, 'http://www.ajeasturiasnetworking.com/wp-content/uploads/2018/05/cloud-computing-network-diagram-download-benefits-and-challenges-of-virtualization-in-the-cloud-of-cloud-computing-network-diagram.jpg'),
...
    ('Concepts', 'What is a Server?', $$It’s like a reservoir – a store of data for multiple users to download, via a browser rather than a tap. Like a reservoir, a server needs to be kept clean and healthy.$$, 'https://www.webdevelopersnotes.com/basics/model3.gif'),
    ('Concepts', 'Describe a Promise', $$It's like a normal promise. A person says they are going to do something in the future -- an operation that hasn't completed yet, but is expected in the future.$$, 'http://exploringjs.com/es6/images/promises----promise_states_all.jpg'),
    ('Technologies', 'Node.js', $$Node.js is a JavaScript runtime built on Chrome's V8 Javascript engine.  It uses an event-driven, non-blocking I/O model.  Node.js's package system, npm, is the largest of open-source libraries in the world.$$, 'https://nodejs.org/static/images/logos/nodejs-new-pantone-black.png'),
