...
    ('Concepts', 'Front-End Processing', 'It is like walking around a city. You interact with the front end – the sidewalks, roads, shops, parks, and office blocks. What you do not see is the back end that keeps the city ticking – the power lines, gas pipes,sewers, and building foundations hidden underground.', 'https://www.classicinformatics.co.uk/wp-content/uploads/2013/04/ui-web-design-prosess1.jpg'),
